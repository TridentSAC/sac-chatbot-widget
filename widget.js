  ...
  connectedCallback() {
    this.innerHTML = `
      <div style="font-family:Arial; position:relative; width:100%; height:100%;">
        ...
        <!-- Toggle Button -->
        <div id="toggle-btn" onclick="this.getRootNode().host._toggle()" style="
        ...
        <div id="chat-panel" style="
          ...
          <div id="chat-log" style="
            ...
            <div style="color:#888; text-align:center; margin-top:80px;">Ask me about supply balance, inventory, or MRP data.</div>
          </div>
